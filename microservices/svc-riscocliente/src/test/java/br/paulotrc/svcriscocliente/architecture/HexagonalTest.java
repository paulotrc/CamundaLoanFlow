package br.paulotrc.svcriscocliente.architecture;
...
@AnalyzeClasses(packages = "br.paulotrc.svcriscocliente", importOptions = {ImportOption.DoNotIncludeTests.class})
