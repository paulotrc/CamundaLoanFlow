package br.paulotrc.contratacaoflow.architecture;
...
@AnalyzeClasses(packages = "br.paulotrc.contratacaoflow", importOptions = {ImportOption.DoNotIncludeTests.class})
